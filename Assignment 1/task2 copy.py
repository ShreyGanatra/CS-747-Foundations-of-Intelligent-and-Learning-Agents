...
if __name__ == '__main__':
  # EXAMPLE CODE
  # task2p1s = [0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9]
  task2p2s = [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9 ]
  # regrets = task2(UCB, 30000, task2p1s, task2p2s)
  # print(regrets)
  # # INSERT YOUR CODE FOR PLOTTING HERE
  # plt.plot(task2p2s,regrets)
  # plt.title("Regret vs probablity of p2")
  # plt.savefig("task2a-UCB.png")
  # plt.clf()

  # regrets = task2(KL_UCB, 30000, task2p1s, task2p2s)
  # plt.plot(task2p2s,regrets)
  # plt.title("Regret vs probablity of p2")
  # plt.savefig("task2a-KL_UCB.png")
  # plt.clf()


  task2p1s = [0.10, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1 ]

  regrets = task2(UCB, 30000, task2p1s, task2p2s,200)
  print(regrets)
  # INSERT YOUR CODE FOR PLOTTING HERE
  plt.plot(task2p2s,regrets)
  plt.title("Regret vs probablity of p2")
